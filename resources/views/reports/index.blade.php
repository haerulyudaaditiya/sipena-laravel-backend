    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <p>Pilih rentang tanggal untuk mengunduh laporan kehadiran.</p>
                    <form action="{{ route('reports.export.attendance') }}" method="POST">
                        @csrf
                        <div class="row align-items-end">
                            <div class="col-md-4 form-group"><label>Tanggal Mulai</label><input type="date" name="start_date" class="form-control" required></div>
                            <div class="col-md-4 form-group"><label>Tanggal Selesai</label><input type="date" name="end_date" class="form-control" required></div>
                            {{-- DITAMBAHKAN: Pilihan Format --}}
            ...
            <div class="card card-info card-outline">
                ...
                <div class="card-body">
                    <p>Pilih rentang tanggal untuk mengunduh rekapitulasi pengajuan cuti.</p>
            ...
            <!-- Laporan Gaji -->
             <div class="card card-success card-outline">
                ...
                <div class="card-body">
                    <p>Pilih bulan dan tahun untuk mengunduh rekapitulasi gaji.</p>
